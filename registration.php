...
<body>
	...
	<div class="wrapper">
        ...
        <div class="right-side">
            ...
            <form action="reg-process.php" method="post" enctype="multipart/form-data" id="rform">
                <div class="form-row">
                    <span>Full Name</span>
                    <input type="text" class="finput" placeholder="Enter your Full Name" name="name" required>
                </div>
                <div class="form-row">
                    <span>E-mail</span>
                ...
                <div class="form-row">
                    ...
                    <input type="password" class="finput" placeholder="Confirm Password " name="password_2" required>
                </div>
